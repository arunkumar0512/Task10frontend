...
function Home() {
  ...
  const handleRegBtn = async () => {
    ...
    https://task10backend.onrender.com


    try {


      const regResponce = await fetch('https://task10backend.onrender.com/api/user/register', {
  ...
  const handleLoginBtn = async () => {
    ...
    const loginRes = await fetch("https://task10backend.onrender.com/api/user/login", {
  ...
  const handleForget = async () => {
    ...
    try {
      ...
      const forgetFetch = await fetch('https://task10backend.onrender.com/api/resetpassword', {
  ...
  const fetchdata = async () => {
    ...
    try {
      ...
      const responce = await fetch("https://task10backend.onrender.com/api/getuser", {
